...
def test_naive_rag_workflow_tracing(exporter):
    ...
    assert parallel_span.parent.span_id == pipeline_span.context.span_id
    assert primary_span.parent.span_id == parallel_span.context.span_id
    assert secondary_span.parent.span_id == parallel_span.context.span_id
    assert merge_span.parent.span_id == pipeline_span.context.span_id
    assert rerank_span.parent.span_id == pipeline_span.context.span_id
    assert prompt_span.parent.span_id == pipeline_span.context.span_id
    assert llm_span.parent.span_id == pipeline_span.context.span_id
...
def test_nested_flow_workflow_tracing(exporter):
    ...
    assert parallel_span.parent.span_id == pipeline_span.context.span_id
    assert all(span.parent.span_id == parallel_span.context.span_id for span in parallel_children)
    assert sum_span.parent.span_id == pipeline_span.context.span_id
...
def test_switch_routing_workflow_tracing(exporter):
    ...
    assert switch_span.parent.span_id == pipeline_span.context.span_id
    assert finalize_span.parent.span_id == pipeline_span.context.span_id
